...
async function initCalculator() {
    ...
    function calculateIncentive() {
        ...
        const contextData = {
            ...
            // Important: include selected interventions and premiums so determinePercentuale
            // and explain() can evaluate multi-intervento and UE premi correctly.
                ...
                try {
                    ...
                    if (detail && detail.appliedPremiums && detail.appliedPremiums.length) {
                        const items = detail.appliedPremiums.map(p => {
                            ...
                            // If value is falsy or zero, show only the name (no € 0,00)
