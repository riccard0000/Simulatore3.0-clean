...
console.log('Small company, many interventions, with all flags:', calculatorData.determinePercentuale(['isolamento-opache','sostituzione-infissi','pompa-calore'], {}, 'private_tertiary_small', { selectedInterventions: ['isolamento-opache','sostituzione-infissi','pompa-calore'], selectedPremiums: ['INCREMENTO_INT3','INCREMENTO_INT4','INCREMENTO_INT5'] }, 'pompa-calore'));
